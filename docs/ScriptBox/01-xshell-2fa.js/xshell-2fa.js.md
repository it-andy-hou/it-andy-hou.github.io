...
<div style="width:100%;max-width:100%;height:500px;overflow-x:auto;overflow-y:hidden;white-space:nowrap;display:flex;align-items:center;">
    <img src="/ScriptBox/01-xshell-2fa.js/codetoimg-snippet.png" alt="Image 1" style="height:100%;margin-right:10px;">
    <img src="/ScriptBox/01-xshell-2fa.js/20250702230039.png" alt="Image 1" style="height:100%;margin-right:10px;">
</div>
